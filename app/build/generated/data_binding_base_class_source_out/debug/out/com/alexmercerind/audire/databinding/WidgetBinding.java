...
public final class WidgetBinding implements ViewBinding {
  ...
  private WidgetBinding(@NonNull RelativeLayout rootView, @NonNull Button refreshButton,
  ...
  public static WidgetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WidgetBinding((RelativeLayout) rootView, refreshButton, titleText);
    }
